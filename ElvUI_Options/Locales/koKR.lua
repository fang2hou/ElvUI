...
L["Add an aura to the filter. Aura IDs can be acquired using the tooltip to find the correct ID."] = "필터에 오라를 추가합니다. 오라 ID는 툴팁을 통해 확인할 수 있습니다."
L["Add an Item by dragging it, shift-clicking, or entering the Item ID onto this field."] = "아이템을 드래그하거나 Shift-클릭하거나 ID를 입력하여 이 필드에 추가합니다."
...
L["Adds an arrow in front of the chat lines to copy the entire line."] = "대화창 행 앞에 화살표를 추가하여 대화를 행별로 통째로 복사할 수 있도록 합니다."
...
L["Alpha Key"] = "투명도"
L["Alternative"] = true
L["Alternative Bling"] = true
L["Always Display"] = "항상 표시"
L["Always show Loot Specialization."] = true
L["Always Show Player"] = "플레이어 항상 표시"
L["Always Show Realm"] = "서버 항상 표시"
L["Always Split Professions"] = "항상 전문 기술 분리"
L["Amount"] = true
L["Anchor"] = "기준"
L["Anchor Offset X"] = true
L["Anchor Offset Y"] = true
L["Anchor Point"] = "기준점"
L["Anchor Type"] = true
...
L["Backdrop Multiplier. Also used for the Transparent multiplier."] = true
...
L["Blend Mode"] = "결합 방식"
L["Blizzard"] = "블리자드"
L["Blizzard Cooldown"] = true
L["Blizzard CVars"] = "블리자드 콘솔변수"
L["Blizzard Font Size"] = true
L["Blizzard Improvements"] = "Blizzard 개선사항"
L["Blizzard Nameplate"] = true
...
L["Change the scale of the Game Menu which shows up when you press ESC."] = "ESC 키를 눌렀을 때 표시되는 게임 메뉴의 크기를 조절합니다."
...
L["Completion flash when the cooldown finishes."] = true
L["Condensed"] = "간략하게"
...
L["Custom Class Colors"] = "사용자 지정 직업 색상"
...
L["Display Mentorship status icon before names."] = true
...
L["Display Timerunning seasonal icon before names."] = true
L["Display Tooltip on Raid Markers."] = true
...
L["Enrage"] = true
L["Environment Conditions"] = "환경 조건"
L["Equipped"] = "착용"
...
L["Fade out the tooltip when it disappears, instant otherwise. Cursor anchored tooltips are unaffected."] = "툴팁이 사라지면 페이드 아웃하고, 그렇지 않으면 즉시 페이드 아웃합니다. 커서 고정 툴팁은 영향을 받지 않습니다."
...
L["Friendly Enabled"] = "아군 대상 활성화"
L["Friendly Spells"] = true
L["Friends"] = "친구"
L["From Me"] = "나에게"
L["From Pet"] = "팻에게"
L["Full"] = "전체"
...
L["Limit the maximum, zero will disable the limit"] = true
...
L["Lock Friendly NPC Plates"] = true
L["Log Taints"] = "오류 기록"
...
L["No Font Scale"] = true
L["No Icon"] = "아이콘 없음"
L["No Label"] = "라벨 없음"
L["No NPC Title"] = "NPC 제목 없음"
L["No Sorting"] = "구분 없음"
L["No Target"] = "대상 없음"
L["Non Selected Alpha"] = true
...
L["Prevent Friendly NPC nameplates from being reset to enabled on login."] = true
...
L["Requires the unit to be the primary target to display."] = "해당 유닛이 주 대상일 경우에만 표시됩니다."
...
L["Reset the Text Format to default."] = true
L["Reset Zoom"] = "배율 초기화"
L["Rest Icon"] = "휴식 아이콘"
...
L["Reverse the cooldown animation."] = true
...
L["Selected Alpha"] = true
L["Selected Scale"] = true
...
L["Share Global"] = true
L["Share Private"] = true
L["Share Profile"] = true
...
L["Talking Head Name"] = true
L["Talking Head Scale"] = "말머리 크기"
L["Talking Head Text"] = true
L["Tank"] = "탱커"
L["Tank Colors"] = "탱커 색상"
...
L["The cooldown timer text."] = true
...
L["This section will help reset specific settings back to default."] = "이 항목은 특정 설정을 기본값으로 초기화합니다"
...
L["Threat"] = "위협(어그로)"
L["Threat similar to Blizzard, which displays your threat from the unit."] = true
...
L["Use the profile specific filter Aura Indicator (Pet) instead of the global filter Aura Indicator."] = "전역 필터 Aura Indicator 대신 프로필 전용 필터 Aura Indicator (소환수)를 사용합니다."
...
L["Wiki:"] = true
L["Will attempt to sell another item in set interval after the previous one was sold."] = "잡동산이 아이템이 판매될때 아이탬간의 시간차를 설정합니다."
L["Will display mana when the main power is:"] = "기본 에너지가 다음과 같을 때 마나를 표시합니다.:"
...
L["World Sub Zone"] = true
L["World Zone Text"] = true
L["Worldboss"] = true
...
L["You are using Overflow with Max Overflow at zero."] = "'오버힐 바 크기' 최대값은 0으로 설정중입니다."
