...
L["TOP"] = "上"
------------  Strata  ------------
L["BACKGROUND"] = true -- should not be translated
L["DIALOG"] = true -- should not be translated
L["HIGH"] = true -- should not be translated
L["LOW"] = true -- should not be translated
L["MEDIUM"] = true -- should not be translated
L["TOOLTIP"] = true -- should not be translated
----------------------------------

L["%s and then %s"] = "%s 與 %s"
L["24-Hour Time"] = "24小時制"
L["Abbreviate Enchants"] = "縮寫附魔"
...
L["Add an aura to the filter. Aura IDs can be acquired using the tooltip to find the correct ID."] = "將光環添加到過濾器中. 光環 ID 可以通過鼠標提示獲取正確的 ID."
L["Add an Item by dragging it, shift-clicking, or entering the Item ID onto this field."] = "通過拖動、按住 Shift 鍵點擊或在此字段中輸入物品 ID 來添加物品."
L["Add Aura ID"] = "添加光環 ID"
L["Add Currency"] = "添加貨幣"
...
L["Adds an arrow in front of the chat lines to copy the entire line."] = "添加一個箭頭於每條聊天記錄之前以便複製整行文字."
L["Adjust the height of your left chat panel."] = "調整左側聊天框的高度"
L["Adjust the height of your right chat panel."] = "調整右側聊天框的高度"
L["Adjust the scale of the minimap and also the pins. Eg: Quests, Resource nodes, Group members"] = "調整小地圖和標記的縮放. 例如: 任務、資源點、小隊成員"
...
L["Allow Tag: Faction"] = "允許標籤: 陣營"
L["Allow Tag: PVP"] = "允許標籤: PVP"
L["Allows BigWigs to rename specific encounter spells on your castbar to something better to understand.\nExample: 'Impaling Eruption' becomes 'Frontal' and 'Twilight Massacre' becomes 'Dash'."] = "允許 BigWigs 將施法條上的特定法術重命名為更容易理解的名稱.\n例如: '穿刺噴發' 變為 '正面' 和 '暮光屠戮' 變為 '衝刺'."
...
L["Alternative"] = "替代"
L["Alternative Bling"] = "使用另一種閃光"
L["Always Display"] = "總是顯示"
L["Always show Loot Specialization."] = "始終顯示專精拾取."
L["Always Show Player"] = "總是顯示玩家"
L["Always Show Realm"] = "總是顯示伺服器"
L["Always Split Professions"] = "總是分開專業包"
L["Amount"] = "數量"
L["Anchor"] = "定位"
L["Anchor Offset X"] = "橫向錨點偏移"
L["Anchor Offset Y"] = "縱向錨點偏移"
L["Anchor Point"] = "定位方向"
L["Anchor Type"] = "錨點類型"
L["Anima Diversion"] = "靈魄靈魄傳導器"
L["Announce Interrupts"] = "斷法通告"
L["Announce when you interrupt a spell to the specified chat channel."] = "在指定對話頻道通知斷法信息."
L["Another Players Pet"] = "另一個玩家的寵物"
L["Any"] = "任意"
L["Append to Cast Name"] = "附加到法術名"
L["Applies the font and font size settings throughout the entire user interface. Note: Some font size settings will be skipped due to them having a smaller font size by default."] = "把該字體設置應用到所有 ElvUI 設置中去, 但是某些設置並不會被改變."
L["Apply Font To All"] = "應用字體到所有"
L["Apply this filter if a buff has remaining time greater than this. Set to zero to disable."] = "當增益剩餘時間大於此值時使用此過濾器, 設為 0 來停用"
L["Apply this filter if a buff has remaining time less than this. Set to zero to disable."] = "當增益剩餘時間小於此值時使用此過濾器, 設為 0 來停用"
L["Apply this filter if a debuff has remaining time greater than this. Set to zero to disable."] = "當減益剩餘時間大於此值時使用此過濾器, 設為 0 來停用"
L["Apply this filter if a debuff has remaining time less than this. Set to zero to disable."] = "當減益剩餘時間小於此值時使用此過濾器, 設為 0 來停用"
...
L["Automatically hide the objective frame during boss fights while you are running a key."] = "在鑰石地城進行時自動隱藏首領戰鬥中的目標框架."
...
L["Backdrop Multiplier"] = "背景乘數"
L["Backdrop Multiplier. Also used for the Transparent multiplier."] = "背景乘數. 也用於透明背景乘數."
...
L["BG Map"] = "戰場地圖"
L["BG Score"] = "戰場計分板"
L["BigWigs Spell Rename"] = "BigWigs 技能重命名"
...
L["Blend Mode"] = "混合模式"
L["Blizzard"] = "暴雪原生"
L["Blizzard Cooldown"] = "暴雪冷卻"
L["Blizzard CVars"] = "暴雪 CVars"
L["Blizzard Font Size"] = "暴雪字體尺寸"
...
L["Change the scale of the Game Menu which shows up when you press ESC."] = "改變按下 Esc 鍵時顯示的遊戲選單縮放."
...
L["Chat Output"] = "聊天輸出"
L["Chat Panels"] = "對話框"
L["Check Focus Cast"] = "檢查焦點施法"
L["Check Mouseover Cast"] = "檢查滑鼠指向施法"
L["Check Self Cast"] = "檢查自我施法"
...
L["Color by Happiness"] = "按快樂度上色"
L["Color By Spec"] = "按專精染色"
L["Color by Unit Class"] = "按單位職業上色"
L["Color by Value"] = "根據數值染色"
L["Color castbar by the class of the unit's class."] = "按單位職業顯示施法條顏色."
L["Color castbar by the reaction of the unit to the player."] = "按單位對玩家的反應顯示施法條顏色."
...
L["Color of the Targets Aura time when expiring."] = "即將過期的目標光環時間顏色."
L["Color of the Targets Aura time."] = "目標光環時間顏色."
...
L["Color when at half of the Low Health Threshold"] = "當生命值低於 50% 時的顏色"
L["Color when at Low Health Threshold"] = "當生命值低於 20% 時的顏色"
...
L["Completion flash when the cooldown finishes."] = "冷卻完成時的閃光效果."
L["Condensed"] = "簡潔"
...
L["Cosmetic"] = "裝飾"
L["Count Text"] = "計數文字"
L["Covenant Preview"] = "盟約預覽"
L["Covenant Renown"] = "誓盟聲望"
...
L["Cursor Anchor Offset X"] = "指針錨點橫向偏移"
L["Cursor Anchor Offset Y"] = "指針錨點縱向偏移"
L["Cursor Anchor Type"] = "指針錨點種類"
L["Custom Anchor"] = "自定義錨點"
L["Custom Backdrop"] = "自訂背景"
L["Custom Class Colors"] = "自訂職業顏色"
L["Custom Color"] = "自定顏色"
...
L["DataText Panels"] = "資訊框"
L["DataTexts"] = "資訊文字"
L["Days"] = "天"
L["Dead or Ghost"] = "死亡或靈魂狀態"
L["Debuff Colors"] = "減益光環顏色"
L["Debuff Highlighting"] = "減益光環加亮顯示"
L["Debuffs on Buffs"] = "在增益上顯示減益"
L["Debug"] = "調試"
L["Debug Tools"] = "除錯工具"
...
L["Display a tank icon over known tanks inside battlegrounds or arenas."] = "在戰場或競技場中, 為已經確認為坦克的玩家標上坦克圖示."
...
L["Display Mana"] = "顯示法力"
L["Display Mentorship status icon before names."] = "在姓名前顯示向導狀態圖示."
...
L["Display Mode"] = "顯示模式"
L["Display Modified Rate"] = "顯示冷卻速率"
L["Display Player"] = "顯示玩家"
L["Display player titles."] = "顯示玩家稱號."
L["Display Style"] = "顯示格式"
L["Display Target"] = "顯示目標"
L["Display Target's Aura Duration, when there is no CD displaying."] = "當沒有冷卻時間顯示時, 顯示目標的光環持續時間."
L["Display Text"] = "顯示文本"
...
L["Display the target of current cast."] = "顯示當前施法目標."
...
L["Display Timerunning seasonal icon before names."] = "在姓名前顯示時空奔行者賽季圖示."
L["Display Tooltip on Raid Markers."] = "在團隊標記上顯示滑鼠提示."
...
L["Displays the gender of players."] = "顯示玩家性別."
...
L["Enable/Disable the World Map Enhancements."] = "啟用/停用世界地圖增強"
L["Enabled"] = "啟用"
L["Enables the ElvUI Raid Control panel."] = "啟用 ElvUI 團隊控制台"
L["Enables the five-second-rule ticks for Mana classes and Energy ticks for Rogues and Druids."] = "為法力職業啟用五秒規則的跳數, 為盜賊和德魯伊啟用能量跳數."
...
L["Enemy Enabled"] = "敵對已啟用"
L["Enemy NPC"] = "敵對 NPC"
L["Enemy Spells"] = "敵對技能"
L["Energy/Mana Regen Tick"] = "能量/法力回復時點"
L["Engineering"] = "工程學"
L["Enhanced PVP Messages"] = "PvP 增強信息"
L["Enrage"] = "激怒"
L["Environment Conditions"] = "環境條件"
L["Equipped"] = "已裝備"
L["Equipped Item"] = "已裝備物品"
...
L["Expansion"] = "資料片"
L["Expansion Button"] = "資料片按鍵"
L["Expansion Landing Page"] = "資料片落地介面"
L["Expiring"] = "即將冷卻完畢"
L["Export"] = "導出"
L["Export Now"] = "現在導出"
L["Export Profile"] = "導出配置文件"
L["Exported"] = "已導出"
L["Extra Buttons"] = "額外按鍵"
L["Fade Chat Toggles"] = "聊天框淡入淡出開關"
L["Fade Duration"] = "漸隱動畫時長"
L["Fade Out"] = "漸隱"
L["Fade Out Delay"] = "淡出延遲"
L["Fade out the tooltip when it disappears, instant otherwise. Cursor anchored tooltips are unaffected."] = "當提示訊息消失時淡出而不是立即消失. 滑鼠錨點的提示訊息不受此選項影響."
...
L["Font Outline"] = "字體描邊"
L["Font Size"] = "字體大小"
L["Font Size as defined by Blizzard."] = "由暴雪定義的字體尺寸."
L["Fonts"] = "字體"
...
L["Friendly Enabled"] = "友方已啟用"
L["Friendly Spells"] = "友方技能"
L["Friends"] = "好友"
L["From Me"] = "來自我"
L["From Pet"] = "來自寵物"
L["Full"] = "滿"
...
L["Groups will be maxed as Mythic to 4, Other Raids to 6, and PVP / World to 8."] = "小隊數量將在神話難度下最大為 4, 在其他團隊副本中最大為 6, 在 PvP 或世界中最大為 8."
L["Growth"] = "增長"
L["Growth Direction"] = "增長方向"
L["Growth direction from the first unitframe."] = "增長方向從第一個頭像框架開始."
L["Growth X-Direction"] = "橫向增長"
L["Growth Y-Direction"] = "縱向增長"
L["Guardians"] = "守護者"
L["Guide Frame"] = "指南框架"
L["Guide:"] = "指導:"
L["Guild Bank"] = "公會銀行"
...
L["Happy"] = "快樂"
L["Has Aura"] = "有光環"
L["Has No Stealable"] = "沒有可竊取的"
L["Has NPC Title"] = "有 NPC 頭銜"
L["Has Stealable"] = "有可竊取的"
L["Headers"] = "標題"
...
L["Help Frame"] = "幫助"
L["Herbalism"] = "草藥學"
L["Here you can add items that you want to be excluded from sorting. To remove an item just click on its name in the list."] = "在這裡你可以添加想要排除在排序之外的物品. 要移除物品只需點擊列表中的名稱."
...
L["Hide Outside PvP"] = "PvP 外隱藏"
L["Hide Quest Progress and Error Text"] = "隱藏任務進度和錯誤文字"
...
L["Hides the yellow quest progress text and red error text at the top of the screen while in combat."] = "在戰鬥中隱藏螢幕頂部的黃色任務進度文字和紅色錯誤文字."
L["High"] = "高"
L["Highlight Color Style"] = "高亮顏色樣式"
L["History"] = "歷史記錄"
...
L["If enabled then the filter will activate if the unit is casting anything."] = "啟用後, 單位施放技能時激活過濾器."
L["If enabled then the filter will activate if the unit is channeling anything."] = "啟用後, 單位引導技能時激活過濾器."
L["If enabled then the filter will activate if the unit is not casting anything."] = "啟用後, 單位未施放技能時激活過濾器."
L["If enabled then the filter will activate if the unit is not channeling anything."] = "啟用後, 單位未引導技能時激活過濾器."
...
L["If enabled then the filter will only activate when the unit has a stealable buff(s)."] = "啟用後, 只有當目標有可以竊取的增益效果時才會激活過濾器."
L["If enabled then the filter will only activate when the unit has no stealable buff(s)."] = "啟用後, 只有當目標沒有可以竊取的增益效果時才會激活過濾器."
...
L["If enabled then the filter will only activate when the unit is in your Party."] = "啟用後僅當單位在你的小隊中時激活."
L["If enabled then the filter will only activate when the unit is in your Raid."] = "啟用後僅當單位在你的團隊中時激活."
...
L["If enabled then the filter will only activate when the unit is not in your Party."] = "啟用後, 只有當目標不在你的隊伍中時才會激活過濾器."
L["If enabled then the filter will only activate when the unit is not in your Raid."] = "啟用後, 只有當目標不在你的團隊中時才會激活過濾器."
...
L["If enabled then the filter will only activate when you have a target."] = "啟用後僅當你有目標時激活."
...
L["Ignored Items (Global)"] = "已忽略物品 (全局)"
L["Ignored Items (Profile)"] = "已忽略物品 (配置文件)"
L["Import"] = "導入"
L["Import Now"] = "現在導入"
L["Import Profile"] = "導入配置文件"
L["Importing"] = "正在導入"
L["In Combat Label"] = "在戰鬥中標籤"
L["In Party"] = "在隊伍中"
L["In Pet Battle"] = "在寵物戰鬥中"
L["In Raid"] = "在團隊副本中"
L["In Vehicle"] = "在載具上"
L["Inactivity Timer"] = "不活躍計時器"
L["Include Reagents"] = "包含材料"
L["Index"] = "索引"
L["Indicate whether buffs you cast yourself should be separated before or after."] = "將你自身施放的增益放於整體增益最前方或或最後方."
L["Indicator"] = "指示器"
L["Indicator Expiring"] = "指示器即將到期"
...
L["LFG Queue"] = "隨機隊列"
L["Library Dropdown"] = "下拉選單庫"
L["Limit the maximum, zero will disable the limit"] = "限制最大值, 零將禁用限制"
...
L["Lock Friendly NPC Plates"] = "鎖定友方 NPC 姓名板"
L["Log Taints"] = "錯誤記錄"
...
L["Maximum tick rate allowed for tag updates per second."] = "標籤每秒最大更新次數."
L["Maximum Time Left"] = "最大時間剩餘"
L["Media"] = "材質"
L["Melee"] = "近戰"
L["Mentorship Icon"] = "導師圖示"
L["Merchant Frame"] = "商人"
...
L["Must be in group with the player if he isn't on the same server as you."] = "如果該玩家與你不在同一伺服器, 則必須與其組隊."
L["My Guild"] = "我的公會"
L["My Threat"] = "我的仇恨"
...
L["No Duration"] = "無持續時間"
L["No Font Scale"] = "無字體縮放"
L["No Icon"] = "無圖示"
L["No Label"] = "無標籤"
L["No NPC Title"] = "無 NPC 標題"
L["No Sorting"] = "不分類"
L["No Target"] = "無目標"
L["Non Selected Alpha"] = "非選定透明度"
...
L["Normal Size"] = "一般尺寸"
L["Not Another Players Pet"] = "不是其他玩家的寵物"
L["Not Being Resurrected"] = "不在復活中"
...
L["Not in Raid"] = "不在團隊中"
L["Not Known"] = "未知"
L["Not My Guild"] = "不是我的公會"
L["Not Owned By Player"] = "玩家未擁有"
L["Not Pet"] = "非寵物"
L["Not Pet Battle"] = "非寵物戰鬥"
L["Not Player Controlled"] = "非玩家控制"
L["Not Possessed"] = "未被控制"
L["Not PvP"] = "非 PvP"
L["Not Quest Unit"] = "非任務單位"
L["Not Resting"] = "不在休息中"
L["Not Spell"] = "非法術"
...
L["Overlay mode is forced when the Frame Orientation is set to Middle."] = "當框架方向設置為中間時, 將強制使用重疊模式."
...
L["Panel Texture (Left)"] = "左側面板材質"
L["Panel Texture (Right)"] = "右側面板材質"
...
L["Prefer Target Color"] = "優先目標顏色"
L["Prevent Friendly NPC nameplates from being reset to enabled on login."] = "防止友方 NPC 姓名板在登入時被重置為啟用狀態."
...
L["Quest Frames"] = "任務"
L["Quest Icon"] = "任務圖示"
L["Quest Progress and Error Text"] = "任務進度和錯誤文字"
L["Quest Small"] = "任務文字 (小)"
...
L["Rarity Color"] = "稀有度顏色"
L["Reaction"] = "聲望"
L["Reaction Castbars"] = "聲望施法條"
L["Reaction Color"] = "聲望顏色"
...
L["Remove a Item Name or ID from the list."] = "從列表中移除物品名稱或 ID"
L["Remove a Name or NPC ID from the list."] = "從列表中移除姓名或 NPC ID"
L["Remove Aura"] = "移除光環"
L["Remove Backdrop"] = "移除背景"
L["Remove Instance ID"] = "清除副本ID"
L["Remove Item Name or ID"] = "移除物品名稱或 ID"
L["Remove Map ID"] = "清除地圖ID"
L["Remove Name or NPC ID"] = "移除姓名或 NPC ID"
L["Remove Spell"] = "移除技能"
L["Remove Spell - %s"] = "移除技能 - %s"
L["Remove Spell ID or Name"] = "移除法術 ID 或法術名"
L["Remove Subzone Name"] = "清除二級地區 ID"
L["Remove Texture"] = "移除材質"
L["Remove Zone Name"] = "清除地區 ID"
L["Renown"] = "聲望"
...
L["Replaces the default Blizzard fonts on various panels and frames with the fonts chosen in the Media section of the ElvUI Options. NOTE: Any font that inherits from the fonts ElvUI usually replaces will be affected as well if you disable this. Enabled by default."] = "用 ElvUI 字體設置代替暴雪原有字體設置, 如果禁用有可能導致你的 UI 出問題, 默認開啟開選項."
L["Replaces the font on Blizzard Nameplates."] = "用 ElvUI 字體設置代替暴雪姓名板字體設置."
...
L["Require All"] = "要求全部"
L["Require holding the Alt key down to move cursor or cycle through messages in the editbox."] = "開啟該選項使你在查看聊天歷史記錄時需要按住 Alt + 上下鍵, 如果關閉則直接按上下鍵即可."
L["Require Target"] = "需要目標"
L["Requires the unit to be the primary target to display."] = "要求該單位作為顯示的主要目標."
L["Reset Action Paging"] = "重置動作翻頁"
L["Reset all frames to their original positions."] = "重置所有框架到預設位置."
...
L["Reset Spells"] = "重置技能"
L["Reset Text"] = "重置文本"
L["Reset the size and position of this frame."] = "重置此框架的大小和位置."
L["Reset the Text Format to default."] = "將文本格式重置為預設值."
L["Reset Zoom"] = "重置縮放"
L["Rest Icon"] = "充分休息圖示"
...
L["Role Order"] = "角色順序"
L["Rotate"] = "旋轉"
L["Round Timers"] = "圓形計時器"
L["Run the installation process."] = "運行安裝過程."
L["Runeforge"] = "符文熔爐"
L["Salute"] = "敬禮"
L["Say"] = "說"
L["Scale"] = "縮放"
...
L["Select the idle animation on the AFK screen."] = "選擇在離開鍵盤螢幕上的閒置動畫."
L["Selected Alpha"] = "選定透明度"
L["Selected Scale"] = "選定縮放"
...
L["Set the priority order of the spell, please note that priorities are only used for the raid debuff module, not the standard buff/debuff module. If you want to disable set to zero."] = "設定該法術的優先順序. 請注意, 優先級只用於團隊副本減益模塊, 而不是標準的增益/減益模塊. 設定為 0 禁用此功能."
...
L["Share Global"] = "分享全局共通設定檔"
L["Share Private"] = "分享角色專屬設定檔"
L["Share Profile"] = "分享設定檔"
...
L["Support"] = "支援及下載"
L["Supported"] = "支援"
L["Swap Modifier"] = "交換修飾鍵"
L["Swap to Alt Power"] = "切換至副能量"
L["Swapped Alt Power"] = "切換至副能量"
L["Swipe Color"] = "色刷顏色"
L["Swipe: Aura"] = "色刷: 光環"
L["Swipe: Charge"] = "色刷: 充能"
L["Swipe: Loss of Control"] = "色刷: 失去控制"
L["Swipe: Normal"] = "色刷: 正常"
L["Swipe: Spell"] = "色刷: 法術"
L["Tab Font"] = "分頁字體"
...
L["Tabard Frame"] = "外袍"
L["Table"] = "表"
L["Tag Update Rate"] = "標籤更新速率"
L["Tagged NPC"] = "標記的NPC"
L["Talk"] = "談話"
L["Talking Head"] = "特寫框架"
L["Talking Head Backdrop"] = "特寫框架背景"
L["Talking Head Name"] = "劇情對話框名稱"
L["Talking Head Scale"] = "特寫框架縮放"
L["Talking Head Text"] = "劇情對話框文字"
L["Tank"] = "坦克"
L["Tank Colors"] = "坦克顏色"
L["Tank Frames"] = "坦克框架"
L["Tank Icon"] = "坦克圖示"
...
L["The cooldown timer text."] = "冷卻計時文字."
...
L["This changes the size of the Aura Icon by this value."] = "這將改變光環圖示的尺寸."
...
L["This list will display any textures Boss Mods have sent to the Boss Mod Auras element during the current session."] = "此列表將顯示在當前連綫期間首領模組發送到首領模組光環組件中的材質."
...
L["This section will help reset specific settings back to default."] = "這個部分會幫助你重置指定的模組設定回預設值"
...
L["This uses the IsPlayerSpell API which is only required sometimes."] = "這使用了 IsPlayerSpell API, 該 API 僅在某些情況下需要."
...
L["This works like a macro, you can run different situations to get the actionbar to page differently.\n Example: '[combat] 2;'"] = "這就像巨集一樣運作, 你可以設定不同情況來切換不同的快捷列頁面.\n範例：'[combat] 2;'"
L["This works like a macro, you can run different situations to get the actionbar to show/hide differently.\n Example: '[combat] show;hide'"] = "這和巨集一樣工作, 能根據不同情況顯示/隱藏快捷列.\n例如: '[combat] show;hide'"
L["Threat similar to Blizzard, which displays your threat from the unit."] = "類似於暴雪框體的仇恨顯示, 顯示來自該單位的仇恨."
...
L["Toggle the camera spin on the AFK screen."] = "切換在離開鍵盤螢幕上的鏡頭旋轉."
...
L["Torghast Level Picker"] = "托迦司等級選擇器"
L["Total Score"] = "總分"
L["Totems"] = "圖騰"
...
L["Use BattleTag instead of Real ID names in chat. Chat History will always use BattleTag."] = "在聊天中使用 Battle Tag 而不是 Real ID. 聊天記錄一直使用 Battle Tag."
...
L["Use Classification Color"] = "使用分類顏色"
...
L["Use Off Tank Color when another Tank has threat."] = "當另一個坦克有仇恨時使用副坦克顏色"
L["Use Portrait"] = "使用頭像"
L["Use Real ID BattleTag"] = "使用 Real ID BattleTag"
L["Use Solo Color"] = "使用單獨顏色"
L["Use solo threat color when not in a group."] = "當不在小組中時使用單獨仇恨顏色"
...
L["Use the profile specific filter Aura Indicator (Pet) instead of the global filter Aura Indicator."] = "使用配置文件專用的光環指示器 (寵物) 代替全局光環指示器."
L["Use the profile specific filter Aura Indicator (Profile) instead of the global filter Aura Indicator."] = "使用配置文件專用的光環指示器 (配置) 過濾器代替全局光環指示器過濾器."
...
L["What to attach the anchor frame to."] = "增益光環框架依附的目標框架."
L["Whats New"] = "新玩意"
...
L["Wiki:"] = true
L["Will attempt to sell another item in set interval after the previous one was sold."] = "將會嘗試使用設定的時間間格後販賣下一個物品"
L["Will display mana when the main power is:"] = "當主要能量是法力時顯示:"
...
L["World Sub Zone"] = "世界子區域"
L["World Zone Text"] = "世界區域文字"
L["Worldboss"] = "世界首領"
L["Wrap After"] = "自動換行于"
L["Wrapped"] = "自動換行"
L["X-Offset"] = "X 軸偏移"
...
L["Y-Offset"] = "Y 軸偏移"
L["Yell"] = "大喊"
L["You are about to reset paging. Are you sure?"] = "你確定要重置分頁嗎?"
...
L["You are using Overflow with Max Overflow at zero."] = "你正在使用溢出風格, 但最大溢出設為零."
...
L["|cffFF3333This is for information. This will not change the tags in the UI.|r"] = "|cffFF3333這個頁面只是爲了展示. 更改編輯框中的内容不影響標簽的邏輯.|r"
L["|cffFF3333Warning:|r Changing options in this section will apply to all Aura Indicator auras. To change only one Aura, please click \"Configure Auras\" and change that specific Auras settings. If \"Profile Specific\" is selected it will apply to that filter set."] = "|cffFF3333警告:|r 在此處變更選項將套用於所有光環指示器光環. 若只想修改單個光環, 可以點擊「設定光環」並變更特定光環設定. 如果選擇了「配置專用」, 它將套用於該過濾器集."
...
L["DEBUG_DESC"] = "禁用除 ElvUI 之外的所有插件. 在同一連綫期間, 再次點擊可以重新啟用它們."
L["DEFAULT"] = "預設值"
L["DEMONIC_FURY"] = "惡魔之怒"
L["DRESSUP_FRAME"] = "試衣間"
...
右鍵點擊: 移除過濾器.
Shift + 左鍵: 在友方、敵方或一般狀態之間切換.
Ctrl + 左鍵: 在允許、阻擋或一般狀態之間切換.

- 一般狀態會對所有單位進行過濾檢查.
- 友方狀態僅針對友方單位, 敵方狀態僅針對敵方單位.
- 阻擋狀態將被視為優先阻擋清單, 允許狀態則為允許清單.
]]
----------------------------------
...
----------  FilterHelp  ----------
L["*Boss:|r ^Auras (debuffs only?) cast by a boss unit.|r"] = "*Boss:|r ^由首領單位施放的光環（僅限減益效果？）.|r"
L["*Mount:|r ^Auras which are classified as mounts.|r"] = "*Mount:|r ^被歸類為坐騎的光環.|r"
L["*Personal:|r ^Auras cast by yourself.|r"] = "*Personal:|r ^由你自己施放的光環.|r"
L["*NonPersonal:|r ^Auras cast by anyone other than yourself.|r"] = "*NonPersonal:|r ^由自己以外的任何人施放的光環.|r"
L["*CastByUnit:|r ^Auras cast by the unit of the unitframe or nameplate (so on target frame it only shows auras cast by the target unit).|r"] = "*CastByUnit:|r ^由單位框架或名條的單位自己施放的光環（因此在目標框架上只顯示目標單位施放的光環）.|r"
L["*NotCastByUnit:|r ^Auras cast by anyone other than the unit of the unitframe or nameplate.|r"] = "*NotCastByUnit:|r ^由單位框架或名條的單位自己以外的任何人施放的光環.|r"
L["*Dispellable:|r ^Auras you can either dispel or spellsteal.|r"] = "*Dispellable:|r ^可以驅散或法術竊取的光環.|r"
L["*CastByNPC:|r ^Auras cast by any NPC.|r"] = "*CastByNPC:|r ^由 NPC 施放的光環.|r"
...
L["*Block Everything, Except Whitelisted Auras:|r ^(1) Whitelist"] = "*阻擋一切, 除了白名單的光環:|r ^(1) Whitelist"
L["*Block Everything, Except Whitelisted Auras That Are Cast By Yourself:|r ^(1) blockNonPersonal | (2) Whitelist"] = "*阻擋一切, 除了白名單的光環和你自己施放的光環:|r ^(1) blockNonPersonal | (2) Whitelist"
----------------------------------
