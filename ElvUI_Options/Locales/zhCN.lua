...
L["Add"] = "添加"
L["Add / Remove"] = "添加/移除"
L["Add a Item Name or ID to the list."] = "向列表添加一个物品名称或者 ID"
L["Add a Name or NPC ID to the list."] = "向列表添加一个名字或者 NPC ID"
...
L["Add an Item by dragging it, shift-clicking, or entering the Item ID onto this field."] = "通过拖动、按住 Shift 键点击或在此字段中输入 ID 来添加物品."
L["Add Aura ID"] = "添加光环ID"
L["Add Currency"] = "添加货币"
L["Add Currency by ID"] = "添加货币 ID"
L["Add Current"] = "添加当前"
L["Add Instance ID"] = "添加副本 ID"
L["Add Item"] = "添加物品"
L["Add Item Name or ID"] = "添加物品名称或者 ID"
L["Add Map ID"] = "添加地图 ID"
L["Add Name or NPC ID"] = "添加名字或 NPC ID"
L["Add Regular Filter"] = "添加常规过滤器"
L["Add Special Filter"] = "添加特殊过滤器"
L["Add Spell ID or Name"] = "添加技能 ID 或者名称"
L["Add SpellID"] = "添加技能 ID"
L["Add Subzone Name"] = "添加子区域名称"
L["Add Texture"] = "添加材质"
L["Add Zone Name"] = "添加区域名称"
L["Added Instance ID: %s"] = "添加的副本 ID: %s"
L["Added Map ID: %s"] = "添加的地图 ID: %s"
...
L["Adds an arrow in front of the chat lines to copy the entire line."] = "在聊天每行信息前加一个箭头来复制整行."
...
L["Allow Tag: Faction"] = "允许标签: 阵营"
L["Allow Tag: PVP"] = "允许标签: PVP"
...
L["Apply this filter if a buff has remaining time greater than this. Set to zero to disable."] = "当增益剩余时间大于该值时应用该过滤器. 设为 0 以禁用."
L["Apply this filter if a buff has remaining time less than this. Set to zero to disable."] = "当增益剩余时间小于该值时应用该过滤器. 设为 0 以禁用."
L["Apply this filter if a debuff has remaining time greater than this. Set to zero to disable."] = "当减益剩余时间大于该值时应用该过滤器. 设为 0 以禁用."
L["Apply this filter if a debuff has remaining time less than this. Set to zero to disable."] = "当减益剩余时间小于该值时应用该过滤器. 设为 0 以禁用."
L["Apply To All"] = "应用到所有"
L["Archaeology Frame"] = "考古学框体"
...
L["Are you sure you want to reset UnitFrames settings?"] = "你确定要重置「单位框体」的设置吗?"
...
L["Assist"] = "助理"
L["Assist Frames"] = "助理框体"
L["At what point should the text be displayed. Set to -1 to disable."] = "在何时显示文本. 设为 -1 以禁用此功能"
L["Attach Text To"] = "文字附着于"
L["Attach To"] = "附加到"
L["Attempt to create URL links inside the chat."] = "在聊天框中创建超链接"
L["Attempt to support eyefinity/nvidia surround."] = "尝试支持 Eyefinity/NVIDIA Surround"
...
L["Auto-Hide"] = "自动隐藏"
L["Automatic"] = "自动"
L["Automatically accept invites from guild/friends."] = "自动接受公会或好友的邀请"
L["Automatically hide the objective frame during boss fights while you are running a key."] = "在史诗地下城中自动隐藏目标框体"
L["Automatically hide the objective frame during boss or arena fights."] = "在首领战或竞技场中自动隐藏任务框体"
...
L["Backdrop Multiplier"] = "背景乘数"
L["Backdrop Multiplier. Also used for the Transparent multiplier."] = "背景乘数. 也用于透明背景乘数."
...
L["Bind on Equip/Use Text"] = "装备时绑定或使用时绑定的文本"
L["Blacklist"] = "黑名单"
...
L["Change the scale of the Game Menu which shows up when you press ESC."] = "更改按下 Esc 时显示的游戏菜单的缩放."
...
L["Choose UIPARENT to prevent it from hiding with the unitframe."] = "选择父级框体来防止它随单位框体隐藏"
...
L["Choosing Settings %s. This will reload the UI.\n\n Are you sure?"] = "正在选择设置 %s. 这将重载界面.\n\n你确定吗?"
L["Chromie Time Frame"] = "克罗米时间框体"
L["Circle"] = "圆"
...
L["Color Score"] = "分数颜色"
L["Color score based on Blizzards API."] = "分数颜色基于暴雪 API"
...
L["Completion flash when the cooldown finishes."] = "冷却完成时的闪光效果."
L["Condensed"] = "紧凑"
...
L["Controls the amount of decimals used in values displayed on elements like NamePlates and UnitFrames."] = "控制像姓名板和团队框体中各数值的小数位数"
...
L["Copy settings from another unit."] = "从其他框体中复制设置."
L["Core |cff1784d1ElvUI|r options."] = "核心 |cff1784d1ElvUI|r 配置."
L["Cosmetic"] = "装饰"
L["Count Text"] = "计数文本"
...
L["Craft"] = "制造"
L["Create a filter, once created a filter can be set inside the buffs/debuffs section of each unit."] = "新建一个过滤器, 一旦新建, 每个单位的增益和减益部分都能使用"
L["Create Custom Text"] = "创建自定义文字控件"
...
L["Cursor Anchor Offset X"] = "鼠标锚点横向偏移"
L["Cursor Anchor Offset Y"] = "鼠标锚点纵向偏移"
...
L["Display Mode"] = "显示模式"
L["Display Modified Rate"] = "显示冷却速率"
...
L["Edge Color"] = "边缘颜色"
L["Edge: Charge"] = "边缘: 充能"
L["Edge: Loss of Control"] = "边缘: 失去控制"
...
L["Enable"] = "启用"
L["Enable + Adjust Movers"] = "启用并移动其他框体"
...
L["Enable/Disable the loot frame."] = "开/关物品掉落框体"
L["Enable/Disable the loot roll frame."] = "开/关掷骰子框体"
...
L["Enable/Disable the on-screen zone text when you change zones."] = "开关区域改变时屏幕上的区域文本."
L["Enable/Disable the World Map Enhancements."] = "开关世界地图增强功能."
L["Enabled"] = "启用"
...
L["Enemy Enabled"] = "敌对已启用"
L["Enemy NPC"] = "敌对 NPC"
L["Enemy Spells"] = "敌对技能"
L["Energy/Mana Regen Tick"] = "能量/法力值回复时间点"
L["Engineering"] = "工程"
L["Enhanced PVP Messages"] = "PVP增强信息"
L["Enrage"] = "激怒"
L["Environment Conditions"] = "环境条件"
L["Equipped"] = "已装备"
...
L["Expansion Landing Page"] = "资料片落地界面"
L["Expiring"] = "即将冷却完毕"
L["Export"] = "导出"
L["Export Now"] = "现在导出"
...
L["Fade out the tooltip when it disappears, instant otherwise. Cursor anchored tooltips are unaffected."] = "启用后鼠标提示消失时淡出, 否则立即消失. 显示在鼠标处的提示不受影响"
...
L["Forces Focus Glow to be disabled for these frames"] = "强制为这些框体禁用焦点发光"
...
L["Groups will be maxed as Mythic to 4, Other Raids to 6, and PVP / World to 8."] = "队伍最大数量为: 史诗团队 4 队, 其他团队 6 队, PvP 或世界 8 队."
L["Growth"] = "增长"
L["Growth Direction"] = "增长方向"
L["Growth direction from the first unitframe."] = "增长方向从第一个头像框体开始"
L["Growth X-Direction"] = "横向增长"
L["Growth Y-Direction"] = "纵向增长"
L["Guardians"] = "护卫"
L["Guide Frame"] = "指南框体"
L["Guide:"] = "指南: "
L["Guild"] = "公会"
...
L["Ignored Items (Global)"] = "忽略物品 (全局共通)"
...
L["Link to the latest PTR version."] = "最新 PTR 版本链接"
...
L["Lock Friendly NPC Plates"] = "锁定友方 NPC 姓名板"
L["Log Taints"] = "错误记录"
...
L["Make the unitframe glow when it is below this percent of health."] = "当生命值低于此百分比时, 使单位框体发光."
...
L["Match if Item Name or ID is NOT in the list."] = "当物品名或 ID 不在列表时匹配"
L["Match if Name or NPC ID is NOT in the list."] = "当名字或 NPC ID 不符合列表时匹配"
...
L["Middle clicking the unit frame will cause your focus to match the unit.\n\n|cffff3333Note:|r If Clique is enabled, this option only effects ElvUI frames if they are not blacklisted in Clique."] = "中键单击单位框体将使您的焦点与单位匹配. \n|cffff3333注意: |r 如果启用了 Clique, 则此选项仅影响 ElvUI 框体, 前提是它们未在 Clique 中列入黑名单."
L["Min Alpha"] = "最小透明度"
L["Min Scale"] = "最小缩放"
...
L["No Icon"] = "无图标"
L["No Label"] = "无标签"
L["No NPC Title"] = "无 NPC 头衔"
L["No Sorting"] = "不排序"
L["No Target"] = "无目标"
L["Non Selected Alpha"] = "非选定透明度"
L["Non-Interruptible"] = "不可打断"
L["Non-Raid Frame"] = "非团队框体"
...
L["Objective Frame Height"] = "任务框体高度"
...
L["Overlay mode is forced when the Frame Orientation is set to Middle."] = "当框体方向设置为‘中间’时强制使用重叠显示模式."
...
L["Portrait"] = "头像"
L["Position"] = "位置"
L["Position of bonus quest reward frame relative to the objective tracker."] = "额外奖励框体相对于任务框体的相对位置"
...
L["Power text will be hidden on NPC targets, in addition the name text will be repositioned to the power texts anchor point."] = "NPC 目标将隐藏能量文字"
L["Power Threshold"] = "能量阈值"
L["Prefer Target Color"] = "首选目标颜色"
L["Prevent Friendly NPC nameplates from being reset to enabled on login."] = "防止友方 NPC 姓名板在登录时被重置为启用状态."
L["Prevent the same messages from displaying in chat more than once within this set amount of seconds, set to zero to disable."] = "屏蔽设置时间(秒)内的重复聊天信息, 0 为禁用此功能"
L["Primary Texture"] = "主要材质"
L["Primary Unit"] = "主要单位"
L["Priority"] = "优先级"
L["Private"] = "角色专属"
L["Private (Character Settings)"] = "角色专属 (角色设置)"
...
L["Profile Name"] = "配置名称"
L["Profile Specific"] = "配置专用"
L["Profiles"] = "配置"
L["Progress Bar"] = "进度条"
L["PTR Version"] = "PTR 版本"
L["Puts coordinates on the world map."] = "在世界地图上显示坐标"
L["PvP & Prestige Icon"] = "PvP 和威望图标"
L["PvP Classification Indicator"] = "PvP 分类指示器"
L["PvP Frames"] = "PvP 框体"
L["PvP Indicator"] = "PvP 指示器"
L["PVP Sub Zone"] = "PVP 子区域"
L["PvP Text"] = "PvP 文字"
L["PVP Trinket"] = "PvP 饰品"
L["PVP Zone Text"] = "PvP 区域文本"
...
L["Remove a Item Name or ID from the list."] = "从列表中移除物品名称或 ID"
L["Remove a Name or NPC ID from the list."] = "从列表中移除姓名或 NPC ID"
L["Remove Aura"] = "移除光环"
L["Remove Backdrop"] = "去除背景"
L["Remove Instance ID"] = "移除副本 ID"
L["Remove Item Name or ID"] = "移除物品名称或 ID"
L["Remove Map ID"] = "移除地图 ID"
L["Remove Name or NPC ID"] = "移除姓名或 NPC ID"
L["Remove Spell"] = "移除技能"
L["Remove Spell - %s"] = "移除技能 - %s"
L["Remove Spell ID or Name"] = "移除技能 ID 或名称"
...
L["Replace Text on Me"] = "替换我身上的战斗文本"
...
L["Replaces the StatusBar texture setting on Unitframes and Nameplates with the primary texture."] = "替换单位框体和姓名板上的状态栏文本设置主要材质"
...
L["Reset all frames to their original positions."] = "重置所有框体到其原始位置"
...
L["Reset Nameplate CVars to the ElvUI recommended defaults."] = "重置姓名板相关 CVars 到 ElvUI 推荐默认值."
L["Reset Priority"] = "重置优先级"
L["Reset Spells"] = "重置技能"
L["Reset Text"] = "重置文本"
L["Reset the size and position of this frame."] = "重置此框体的尺寸和位置."
L["Reset the Text Format to default."] = "将文本格式重置为默认值."
L["Reset Zoom"] = "重置缩放"
L["Rest Icon"] = "充分休息图标"
...
L["Run the installation process."] = "执行安装流程"
L["Runeforge"] = "符文熔炉"
L["Salute"] = "敬礼"
L["Say"] = "说"
L["Scale"] = "缩放"
...
L["Select the idle animation on the AFK screen."] = "选择暂离界面的闲置动画."
L["Selected Alpha"] = "选定透明度"
L["Selected Scale"] = "选定缩放"
...
L["Set the font size for everything in UI. Note: This doesn't effect somethings that have their own separate options (UnitFrame Font, Datatext Font, ect..)"] = "设置界面上所有字体的尺寸, 但不包含本身有独立设置的字体 (如单位框体字体、信息文字字体等) "
L["Set the order that the group will sort."] = "设置组排序的顺序"
L["Set the orientation of the UnitFrame."] = "设置框体的方向"
L["Set the priority order of the spell, please note that priorities are only used for the raid debuff module, not the standard buff/debuff module. If you want to disable set to zero."] = "设置该法术的优先顺序. 请注意, 优先级只用于团队副本减益模块, 而不是标准的增益或减益模块. 设为 0 以禁用此功能"
...
L["Share Current Profile"] = "分享当前配置"
L["Share Filters"] = "分享过滤器"
L["Share Global"] = "分享全局共通配置"
L["Share Private"] = "分享角色专属配置"
L["Share Profile"] = "分享配置"
...
L["Show an incoming heal prediction bar on the unitframe. Also display a slightly different colored bar for incoming overheals."] = "在单位框体中显示即将回复的的预估治疗量, 过量治疗则以不同颜色显示"
...
L["Show ElvUI Users"] = "显示 ElvUI 用户"
L["Show ElvUI users and their version of ElvUI."] = "显示 ElvUI 用户与他们的 ElvUI 版本."
...
L["Show Zone"] = "显示区域"
L["Show/Hide Test Frame"] = "显示/隐藏测试框体"
...
L["The cooldown timer text."] = "冷却计时文字."
...
L["The frame is not shown unless you mouse over the frame."] = "只在鼠标移到框体上时显示"
...
L["This section will help reset specific settings back to default."] = "这部分将帮助你重置特定设置为默认."
L["This selects the Chat Frame to use as the output of ElvUI messages."] = "选择 ElvUI 信息的聊天输出."
L["This setting controls the size of text in item comparison tooltips."] = "设置物品对比鼠标提示中的文字尺寸."
...
L["Threat"] = "仇恨"
L["Threat similar to Blizzard, which displays your threat from the unit."] = "类似于暴雪框体的仇恨显示, 显示来自该单位的仇恨."
L["Threshold (in minutes) before text is shown in the HH:MM format. Set to -1 to never change to this format."] = "文字以时:分格式显示的阈值 (单位: 分). 设为 -1 以禁用此格式."
L["Threshold (in seconds) before text is shown in the MM:SS format. Set to -1 to never change to this format."] = "文字以分:秒格式显示的阈值 (单位: 秒). 设为 -1 以禁用此格式."
L["Threshold before text turns red and is in decimal form. Set to -1 for it to never turn red"] = "冷却时间低于此秒数后将变为红色数字, 并以小数显示, 设为 -1 来使其不会变为红色"
L["Threshold before the icon will fade out and back in. Set to -1 to disable."] = "图标闪烁时的阈值, 设为 -1 以禁用."
...
L["Toggle the camera spin on the AFK screen."] = "暂离界面的镜头旋转开关."
L["Toggle the chat tab panel backdrop."] = "显示/隐藏聊天框体标签面板背景"
...
L["Unit Target"] = "单位目标"
L["Unit Type"] = "单位类型"
L["Unitframe Thin Borders"] = "单位框体细边框"
L["UnitFrames"] = "单位框体"
L["Unitframes Border"] = "单位框体边框"
L["Unlock various elements of the UI to be repositioned."] = "解锁界面上的各种框体来更改位置"
L["Up"] = "上"
L["Upgrade Icon"] = "升级图标"
L["URL Links"] = "网址链接"
L["Usable"] = "可用"
...
L["Use Classification Color"] = "使用分类颜色"
...
L["Use Instance ID or Name"] = "使用副本 ID 或名称"
L["Use Map ID or Name"] = "使用地图 ID 或名称"
...
L["Use Solo Color"] = "使用单人颜色"
L["Use solo threat color when not in a group."] = "在非团队状态下使用单人仇恨颜色."
...
L["Use thin borders on certain unitframe elements."] = "在特定单位框体上面使用细边框"
...
L["Will attempt to sell another item in set interval after the previous one was sold."] = "尝试在设置的周期后卖出下一个物品"
L["Will display mana when the main power is:"] = "显示法力值, 当主能量为: "
...
L["You are using Overflow with Max Overflow at zero."] = "|cffFF9933你正在使用溢出风格, 但最大溢出值为零.|r "
...
L["DEBUG_DESC"] = "禁用除 ElvUI 之外的所有插件. 在同一会话期间, 再次单击可以重新启用它们."
L["DEFAULT"] = "默认"
L["DEMONIC_FURY"] = "恶魔之怒"
L["DRESSUP_FRAME"] = "试衣间"
...
L["KEY_BINDINGS"] = "按键设置"
L["LANGUAGE"] = "语言"
L["LEVEL_BOSS"] = "对首领请设置为 -1, 或者设为 0 以禁用."
L["LFG_TITLE"] = "寻求组队"
...
右键点击: 移除过滤器.
Shift + 左键点击: 在友好、敌对或普通状态之间切换.
Ctrl + 左键点击: 在允许、阻止或普通状态之间切换.

- 通用状态会对所有单位应用过滤器.
- 友方状态仅对友方单位生效, 敌方状态仅对敌方单位生效.
- 阻止状态作为黑名单(优先阻止), 允许状态作为白名单(优先允许).
]]
----------------------------------
...
L["*CastByUnit:|r ^Auras cast by the unit of the unitframe or nameplate (so on target frame it only shows auras cast by the target unit).|r"] = "*CastByUnit: |r ^由单位框体或姓名板的单位自己施放的光环 (因此在目标框体上只显示目标单位施放的光环).|r"
L["*NotCastByUnit:|r ^Auras cast by anyone other than the unit of the unitframe or nameplate.|r"] = "*NotCastByUnit: |r ^由单位框体或姓名板的单位自己以外的任何人施放的光环.|r"
L["*Dispellable:|r ^Auras you can either dispel or spellsteal.|r"] = "*Dispellable: |r ^可以驱散或法术窃取的光环.|r"
L["*CastByNPC:|r ^Auras cast by any NPC.|r"] = "*CastByNPC: |r ^由 NPC 施放的光环.|r"
